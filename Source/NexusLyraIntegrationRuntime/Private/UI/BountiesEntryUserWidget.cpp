...
void UBountiesEntryUserWidget::SetBountyDescription(FString InDescription)
{
	if (InDescription.IsEmpty())
	{
		...
		UE_LOG(LogTemp, Warning, TEXT("Warning! Bounty description was null"));
		return;
	}
...
void UBountiesEntryUserWidget::SetBountyImage(FString InURL)
{
	if (InURL.IsEmpty())
	{
		...
		UE_LOG(LogTemp, Warning, TEXT("Warning! Bounty image source was null"));
		return;
	}
...
void UBountiesEntryUserWidget::SetBountyTitle(FString InTitle)
{
	if (InTitle.IsEmpty())
	{
		...
		UE_LOG(LogTemp, Warning, TEXT("Warning! Bounty title was null"));
		return;
	}
